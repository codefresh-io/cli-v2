...
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.496/cf-linux-amd64.tar.gz | tar zx
...
```bash
# download and extract the binary
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.496/cf-darwin-amd64.tar.gz | tar zx
