...
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.305/cf-linux-amd64.tar.gz | tar zx
...
# download and extract the binary
<<<<<<< HEAD
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.305/cf-darwin-amd64.tar.gz | tar zx
=======
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.304/cf-darwin-amd64.tar.gz | tar zx
>>>>>>> origin/main
