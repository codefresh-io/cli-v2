...
- Argo Rollouts [v1.1.0](https://github.com/argoproj/argo-rollouts/releases/tag/v1.2.0)
...
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.351/cf-linux-amd64.tar.gz | tar zx
...
```bash
# download and extract the binary
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.351/cf-darwin-amd64.tar.gz | tar zx
