...
* Argo CD [v2.1.0](https://github.com/codefresh-io/argo-cd/releases/tag/v2.1.0)
...
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.126/cf-linux-amd64.tar.gz | tar zx
...
```bash
# download and extract the binary
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.126/cf-darwin-amd64.tar.gz | tar zx
