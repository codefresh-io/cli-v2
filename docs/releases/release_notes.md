...
- Argo CD [v2.1.11](https://github.com/argoproj/argo-cd/releases/tag/v2.1.11)
...
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.285/cf-linux-amd64.tar.gz | tar zx
...
```bash
# download and extract the binary
curl -L --output - https://github.com/codefresh-io/cli-v2/releases/download/v0.0.285/cf-darwin-amd64.tar.gz | tar zx
