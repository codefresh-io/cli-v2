...
func init() {
	...
	s.CronExampleEventSourceFileName = "cron.event-source.yaml"
	s.CronExampleSensorFileName = "cron.sensor.yaml"
	s.CronExampleWfTemplateFileName = "hello-world.workflow-template.yaml"
