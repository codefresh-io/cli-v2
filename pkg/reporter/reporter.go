...
const (
	...
	UpgradeStepAddInternalRouterAppliedFlag  CliStep = "upgrade.run.step.add-internal-router-applied-flag"
	UpgradeStepPushInternalRouterAppliedFlag CliStep = "upgrade.run.step.push-internal-router-applied-flag"
