...
COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL="github.com/codefresh-io/cli-v2/manifests/components-reporter?ref=$(VERSION)"
...
DEV_COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL="manifests/components-reporter"
...
ifeq (${DEV_MODE},true)
	...
	COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL=${DEV_COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL}
endif
...
$(OUT_DIR)/$(CLI_NAME)-%: $(CLI_SRCS)
	...
	COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL=$(COMPONENTS_REPORTER_INSTALLATION_MANIFESTS_URL) \
	MAIN=./cmd \
	./hack/build.sh
